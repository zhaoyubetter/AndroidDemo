...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs, int defStyle) {
        ...
        setOutcontourColor(a.getColor(R.styleable.WheelView_wv_outcontour_color, Color.GREEN));
        setOutBoundsColor(a.getColor(R.styleable.WheelView_wv_outcontour_color, Color.DKGRAY));
    ...
    private void drawProgress(Canvas canvas) {
        ...
        switch (mContourMode) {
            case OUT_CONTOUR:
                // 画外圆,空心
                drawArc(canvas, Paint.Style.STROKE, 360, false, new RectF(mOutcontourWidth, mOutcontourWidth, width - mOutcontourWidth, height - mOutcontourWidth), mOutBundersColor, mOutcontourWidth);
                drawArc(canvas, Paint.Style.STROKE, degress, false, new RectF(mOutcontourWidth, mOutcontourWidth, width - mOutcontourWidth, height - mOutcontourWidth), mOutcontourColor,
                        mOutcontourWidth);
                break;
            case INNER_CONTOUR:
                // 画内圆,实心
                drawArc(canvas, Paint.Style.FILL, degress, true, getInnerRect(width, height), mInnercontourColor, mInnercontourWidth);
                break;
            case RVS_CONTOUR:
                // 内外反向
            ...
            case ALL_CONTOUR:
                // 画内外圆
                drawArc(canvas, Paint.Style.STROKE, 360, false, new RectF(mOutcontourWidth, mOutcontourWidth, width - mOutcontourWidth, height - mOutcontourWidth), mOutBundersColor, mOutcontourWidth);
                drawArc(canvas, Paint.Style.STROKE, mCurrentDegress, false, new RectF(mOutcontourWidth, mOutcontourWidth, width - mOutcontourWidth, height - mOutcontourWidth), mOutcontourColor,
                        mOutcontourWidth);
                drawArc(canvas, Paint.Style.FILL, degress, true, getInnerRect(width, height), mInnercontourColor, mInnercontourWidth);
                break;
            default:
