...
public class ArrayAdapter<T> extends BaseAdapter {
	...
	public ArrayAdapter(Context context, T[] objects) {
		init(context, R.layout.simple_list_item_1, 0, Arrays.asList(objects));
	}
	...
	public ArrayAdapter(Context context, List<T> objects) {
		init(context, R.layout.simple_list_item_1, 0, objects);
	}
	...
	public static ArrayAdapter<CharSequence> createFromResource(Context context, int textArrayResId, int textViewResId) {
		...
		return new ArrayAdapter<CharSequence>(context, strings);
	}
